...
def save_pathes():
    ...
    direct = '../../data/msrc_r0r1r2_21jnts_u72v72d300_20151030/center_derot/'
    prev_jnt_path ='%s%s_center_r0r1r2_uvd_c0016_c0132_c1016_c1132_c2016_c2132_h16_h216_gm0_lm399_yt0_ep770.npy'%(direct,dataset)

    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi_base_uvd_normalized_enlarge(path,prev_jnt_path,dataset='train',jnt_idx=jnt_idx,num_enlarge=num_enlarge,
                                                                                                     patch_size=patch_size,offset_depth_range=offset_depth_range,batch_size=batch_size)

    f = h5py.File('train_patch56_1.0_lg3','w')
    ...
    direct = '../../data/msrc_r0r1r2_21jnts_u72v72d300_20151030/center_derot/'
    prev_jnt_path ='%s%s_center_r0r1r2_uvd_c0016_c0132_c1016_c1132_c2016_c2132_h16_h216_gm0_lm399_yt0_ep770.npy'%(direct,dataset)
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_multi_base_uvd_normalized_enlarge(path,prev_jnt_path,dataset=None,jnt_idx=jnt_idx,num_enlarge=num_enlarge,
                                                                                                     patch_size=patch_size,offset_depth_range=offset_depth_range,batch_size=batch_size)
    f = h5py.File('test_patch56_1.0_lg3','w')
