...
def load_data_multi_tip_uvd_normalized(path,pre_jnt_path,jnt_idx,is_shuffle,patch_size=24, patch_pad_width=4,offset_depth_range=0.8,hand_width=96,hand_pad_width=0):
...
def load_data_multi_tip_uvd_normalized_enlarge(path,pre_jnt_path,jnt_idx,num_enlarge,dataset=None,patch_size=44, patch_pad_width=4,offset_depth_range=0.8,batch_size=100):
    '''creat pathes based on ground truth
    htmap is a qunatized location for each joint
    '''
