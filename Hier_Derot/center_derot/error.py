...
def center_derot_err_uvd_xyz(dataset,dataset_path_prefix,setname,source_name,source_name_ori,pred_save_name):
    # dataset='test'
    ...
    pred_path='%sdata/%s/hier_derot/center/'%(dataset_path_prefix,setname)
...
if __name__=='__main__':
    center_derot_err_uvd_xyz(dataset = 'test',
                             setname='icvl',
                             ...
                             pred_save_name='_center_r0r1r2_c0016_c0132_c1016_c1132_c2016_c2132_h16_h216_gm0_lm300_yt0_ep2470')
    #
