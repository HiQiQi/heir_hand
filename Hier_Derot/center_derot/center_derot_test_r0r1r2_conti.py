...
def train_model(setname,dataset_path_prefix,dataset, source_name,batch_size,model_save_path,pred_save_name):
    ...
    save_path = '%sdata/%s/hier_derot/center/best/'%(dataset_path_prefix,setname)
...
if __name__ == '__main__':
    ...
    train_model(dataset='test',
                ...
                batch_size = 133,
                model_save_path='param_cost_center_r0r1r2_uvd_c0016_c0132_c1016_c1132_c2016_c2132_h16_h216_gm0_lm300_yt0_ep1445',
                pred_save_name='_center_r0r1r2_uvd_c0016_c0132_c1016_c1132_c2016_c2132_h16_h216_gm0_lm300_yt0_ep1445')
    #
    # train_model(dataset='test',
    #             dataset_path_prefix='C:/Proj/Proj_CNN_Hier/',
    #             setname='nyu',
