...
save_path = '../../data/icvl/base_wrist_spacial/'
model_save_path = "%sparam_cost_uvd_bw_r012_21jnts_derot_lg0_patch56_c0016_c0132_c1016_c1132_c2016_c2132_h12_h24_gm0_lm9999_yt0_ep900.npy"%save_path
...
model_info = numpy.load(model_save_path)
train_cost = numpy.array(model_info[-2][1][1:-1])
test_cost = numpy.array(model_info[-1][1][1:-1])
