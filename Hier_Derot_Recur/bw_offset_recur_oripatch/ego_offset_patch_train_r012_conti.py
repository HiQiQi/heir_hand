...
def train_model(setname, source_name,batch_size,jnt_idx,patch_size,offset_depth_range,c1,c2,h1_out_factor,h2_out_factor,lamda):
    ...
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_r012_ego_offset(path=path,is_shuffle=True,
    ...
    test_set_x0, test_set_x1,test_set_x2,test_set_y= load_data_r012_ego_offset(path=path,is_shuffle=True,jnt_idx=jnt_idx,
                                                                               offset_depth_range=offset_depth_range,
    ...
    done_looping=False
    save_path =    '../../data/%s/recursive/base_wrist/'%setname
