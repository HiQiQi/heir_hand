...
def train_model(setname,source_name,lamda,c1,c2,h1_out_factor,h2_out_factor,batch_size):

    # jnt_type='base' # jnt_type : base,mid, tip

    model_info='whole_21jnts_r012_conti'
    jnt_idx = range(0,21,1)
    print jnt_idx
    dataset = 'train'
    src_path = '../../data/%s/source/'%setname
    path = '%s%s%s.h5'%(src_path,dataset,source_name)
    train_set_x0, train_set_x1,train_set_x2,train_set_y= load_data_multi(path,jnt_idx,is_shuffle=False)
    ...
    save_path =  '../../data/nyu/whole/best/'
    model_save_path = "%sparam_cost_whole_21jnts_r012_conti_c0032_c0164_c1032_c1164_c2032_c2164_h18_h232_gm0_lm300_yt0_ep885.npy"%save_path
    set_params(model_save_path, model.params)

    print 'gamma_%f, lamda_%f,yita_%f'%(gamma, lamda,yita)
    save_path = '../../data/%s/whole/'%setname
...
if __name__ == '__main__':
    # train_model(setname='icvl',source_name='_icvl_r0_r1_r2_uvd_bbox_21jnts_20151113_depth200', lamda=0.01,c1=32,c2=64,h1_out_factor=8,h2_out_factor=32)
